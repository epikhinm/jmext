...
import me.schiz.sampler.RawBeanShellSampler;
...
public class RawBeanShellSamplerGui extends AbstractSamplerGui {
    ...
    public RawBeanShellSamplerGui() {
        init();
    }

    @Override
    public void configure(TestElement element) {
        scriptField.setText(element.getPropertyAsString(RawBeanShellSampler.SCRIPT));
        filename.setText(element.getPropertyAsString(RawBeanShellSampler.FILENAME));
        parameters.setText(element.getPropertyAsString(RawBeanShellSampler.PARAMETERS));
        resetInterpreter.setSelected(element.getPropertyAsBoolean(RawBeanShellSampler.RESET_INTERPRETER));
        super.configure(element);
    }

    public TestElement createTestElement() {
        RawBeanShellSampler sampler = new RawBeanShellSampler();
    ...
    public void modifyTestElement(TestElement te) {
        ...
        te.setProperty(RawBeanShellSampler.SCRIPT, scriptField.getText());
        te.setProperty(RawBeanShellSampler.FILENAME, filename.getText());
        te.setProperty(RawBeanShellSampler.PARAMETERS, parameters.getText());
        te.setProperty(new BooleanProperty(RawBeanShellSampler.RESET_INTERPRETER, resetInterpreter.isSelected()));
    }
    ...
    public String getStaticLabel() {
    	return "jm@ext RawBeanShell Sampler";
    }
    ...
    private JPanel createFilenamePanel()// TODO ought to be a FileChooser ...
    {
        ...
        filename.setName(RawBeanShellSampler.FILENAME);
    ...
    private JPanel createParameterPanel() {
        ...
        parameters.setName(RawBeanShellSampler.PARAMETERS);
    ...
    private JPanel createResetPanel() {
        ...
        resetInterpreter.setName(RawBeanShellSampler.PARAMETERS);
