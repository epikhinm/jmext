 ...
 * 
 */
package me.schiz.sampler;

/**
 * @author schizophrenia
 * RawBeanShell Sampler for TRUE OPERATIONS
 */
/*
 ...
 *
 */
public class RawBeanShellSampler extends BeanShellTestElement implements Sampler, Interruptible, ConfigMergabilityIndicator
{
    ...
    public SampleResult sample(Entry e)// Entry tends to be ignored ...
    {
        ...
        try {
            ...
            bshInterpreter.set("setName", setName);
            ...
            if (bshInterpreter.get("SampleResult") instanceof SampleResult) 
            	res = (SampleResult) bshInterpreter.get("SampleResult");
            else {
            	if(setName == true)	res.setSampleLabel(getName());
                res.setResponseCode("503");//$NON-NLS-1$
                res.setResponseMessage("SampleResult not found");
                res.setSuccessful(false);
                return res;
            }
        }
