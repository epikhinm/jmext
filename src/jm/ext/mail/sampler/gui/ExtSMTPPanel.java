 ...
 */
public class ExtSMTPPanel extends JPanel {

    private static final long serialVersionUID = 1L;
    // Extensions
    private JTextField tfConnectionTimeout;
    private JTextField tfSocketTimeout;
    private JCheckBox cbQuitWait;
    // local vars
    ...
    private JCheckBox cbReuseTransport;
    private JCheckBox cbReconnect;
    ...
    private JLabel jlConnectionTimeout;
    private JLabel jlSocketTimeout;
    ...
    public String getConnectionTimeout() {
        return tfConnectionTimeout.getText();
    }
    
    public void setConnectionTimeout(String connectionTimeout) {
        tfConnectionTimeout.setText(connectionTimeout);
    }
    
    public String getSocketTimeout() {
        return tfSocketTimeout.getText();
    }
    
    public void setSocketTimeout(String socketTimeout) {
        tfSocketTimeout.setText(socketTimeout);
    }
    
    public boolean getQuitWait() {
        return cbQuitWait.isSelected();
    }
    
    public void setQuitWait(boolean b) {
        cbQuitWait.setSelected(b);
    }
    public boolean getReuseTransport() {
        return cbReuseTransport.isSelected();
    }
    
    public void setReuseTransport(boolean b) {
        cbReuseTransport.setSelected(b);
    }
    public boolean getReconnect() {
        return cbReconnect.isSelected();
    }
    
    public void setReconnect(boolean b) {
        cbReconnect.setSelected(b);
    }
    ...
    public CollectionProperty getHeaderFields() {
        ...
        result.setName(ExtSMTPSampler.HEADER_FIELDS);
    ...
    private void initComponents() {
        ...
        jlConnectionTimeout = new JLabel("Connection Timeout");
        jlSocketTimeout = new JLabel("Socket Timeout");
        ...
        //Extensions
        tfConnectionTimeout = new JTextField(6);
        tfSocketTimeout = new JTextField(6);
        cbQuitWait = new JCheckBox("QuitWait", true);
        cbReuseTransport = new JCheckBox("Reuse Transport");
        cbReconnect = new JCheckBox("Reconnect");
        ...
        JPanel panelServerExtSettings = new JPanel(new GridBagLayout());
        panelServerExtSettings.setBorder(BorderFactory.createTitledBorder(
                BorderFactory.createEtchedBorder(),
                "Extensions"));
        //Extensions
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        panelServerExtSettings.add(jlConnectionTimeout, gridBagConstraints);

        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 0;
        panelServerExtSettings.add(tfConnectionTimeout, gridBagConstraints);

        //SocketTimeout
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 0;
        panelServerExtSettings.add(jlSocketTimeout, gridBagConstraints);

        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 0;
        panelServerExtSettings.add(tfSocketTimeout, gridBagConstraints);

        //QuitWait
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridy = 0;
        panelServerExtSettings.add(cbQuitWait, gridBagConstraints);

        gridBagConstraints.gridx = 5;
        gridBagConstraints.gridy = 0;
        panelServerExtSettings.add(cbReuseTransport, gridBagConstraints);
        
        gridBagConstraints.gridx = 6;
        gridBagConstraints.gridy = 0;
        panelServerExtSettings.add(cbReconnect, gridBagConstraints);
        
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 2;
        //panelServerSettings.add(panelServerExtSettings, gridBagConstraints);
        ...
        add(panelServerExtSettings, gridBagConstraintsMain);
    ...
    private void attachmentFolderFileChooserActionPerformed(ActionEvent evt) {
        ...
        if (null != attachments && attachments.length() > 0) {
            tfAttachment.setText(attachments
                            + ExtSMTPSampler.FILENAME_SEPARATOR
     ...
     */
    public void clear() {
        tfConnectionTimeout.setText("");
        tfSocketTimeout.setText("");
        cbQuitWait.setSelected(true);
        cbReuseTransport.setSelected(false);
        cbReconnect.setSelected(false);
